...
Export Date: 2026-01-20 08:14:23
...
./Import-SqlServerSchema.ps1 -Server "target-server" -Database "target-db" -SourcePath "localhost,1433_TestDb_20260120_081416"

# With SQL authentication
$cred = Get-Credential
./Import-SqlServerSchema.ps1 -Server "target-server" -Database "target-db" -SourcePath "localhost,1433_TestDb_20260120_081416" -Credential $cred

# Production mode (includes FileGroups, DB Configurations, External Data)
./Import-SqlServerSchema.ps1 -Server "target-server" -Database "target-db" -SourcePath "localhost,1433_TestDb_20260120_081416" -ImportMode Prod

# Include data
./Import-SqlServerSchema.ps1 -Server "target-server" -Database "target-db" -SourcePath "localhost,1433_TestDb_20260120_081416" -IncludeData

# Create database if it doesn't exist
./Import-SqlServerSchema.ps1 -Server "target-server" -Database "target-db" -SourcePath "localhost,1433_TestDb_20260120_081416" -CreateDatabase

# Force apply even if schema already exists
./Import-SqlServerSchema.ps1 -Server "target-server" -Database "target-db" -SourcePath "localhost,1433_TestDb_20260120_081416" -Force

# Continue on errors (useful for idempotency)
./Import-SqlServerSchema.ps1 -Server "target-server" -Database "target-db" -SourcePath "localhost,1433_TestDb_20260120_081416" -ContinueOnError
```
